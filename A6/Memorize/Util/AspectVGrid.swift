...
//  Memorize
//
//  Created by Artur Masalcev on 2021-06-29.
//

import SwiftUI

/// Variant of LazyVGrid that automatically choses the right size for its' elements depending on the aspect ratio of the elements and given space in parent view
